...
namespace oe::gui
{
	...
	struct ColorPickerWheelInfo
	{
		bool preview                      = true;
		bool alpha                        = true;
		ColorPickerInfo color_picker_info = { oe::colors::red, 2, oe::colors::dark_grey, nullptr, false, close_fn::never, open_fn::never, { { 200, 225 }, { 0, 0 }, oe::alignments::center_center, oe::alignments::center_center } };
	};
	...
	public:
		ColorPickerWheel(Widget* parent, GUI& gui_manager, glm::vec4& m_value_ref, const ColorPickerWheelInfo& color_picker_info = {});
		ColorPickerWheel(Widget* parent, GUI& gui_manager, const ColorPickerWheelInfo& color_picker_info = {})
			: ColorPickerWheel(parent, gui_manager, m_color_picker_info.color_picker_info.initial_color, color_picker_info)
		{}
		~ColorPickerWheel();
