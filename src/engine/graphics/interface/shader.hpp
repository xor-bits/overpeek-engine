...
namespace oe::graphics {
	...
	public:
		...
		virtual void setUniform(const std::string& name, const size_t count, const int32_t* values) = 0;
		...
		virtual void setUniform(const std::string& name, const size_t count, const uint32_t* values) = 0;
		virtual void setUniform(const std::string& name, const size_t count, const glm::uvec2* values) = 0;
		virtual void setUniform(const std::string& name, const size_t count, const glm::uvec3* values) = 0;
		virtual void setUniform(const std::string& name, const size_t count, const glm::uvec4* values) = 0;
